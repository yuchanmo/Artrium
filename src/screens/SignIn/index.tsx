...
interface Props{
  ...
  navigation:NativeStackScreenProps<RootStackParamList,"SignIn">;    
}
    ...
    <Wrapper>         
          ...
          <ButtonWrapper>
            <Fragment>
              ...
              <Button transparent title="Login CHO" onPress={() => trySignIn(2)}/>
              <Button transparent title="Login MO" onPress={() => trySignIn(1)}/>
            </Fragment>
          </ButtonWrapper>
        </Wrapper>
    </View>
